          ...
          <div class="card-body"><h5 class="card-title">Medium Scrollable Area</h5>
            <div class="scroll-area-md">
              <VuePerfectScrollbar class="scrollbar-container" v-once>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum sodales ullamcorper vehicula. Duis placerat quam porta lorem lobortis, sit amet sodales mauris
      ...
      <div class="col-lg-6">
        ...
        <div class="main-card mb-3 card">
          <div class="card-body">
            ...
            <b-dropdown text="Left Aligned Header" class="mb-2 mr-2" menu-class="dropdown-menu-lg" variant="primary">
              <div class="dropdown-menu-header">
            ...
            <b-dropdown text="Left Aligned Header Buttons" class="mb-2 mr-2" menu-class="dropdown-menu-lg" variant="primary">
              <div class="dropdown-menu-header">
