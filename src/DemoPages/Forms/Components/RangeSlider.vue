      ...
      <b-row>
        <b-col md="6">
          ...
          <b-card class="main-card mb-3">
            ...
            <br>
            <div class="btn-group btn-group-sm">
              <button class="btn btn-secondary" @click="setValue('demo4', ['10-02', '10-12'])">set value = ["10-02", "10-12"]</button>
              <button class="btn btn-secondary" @click="setIndex('slider4', [3, 10])">set index = [3, 10]</button>
          ...
          <b-card class="main-card mb-3">
            ...
            <br>
            <div class="btn-group btn-group-sm">
              <button class="btn btn-secondary" @click="setValue('demo9', [0, 30])">set value = [0, 30]</button>
              <button class="btn btn-secondary" @click="demo.demo9.fixed = !demo.demo9.fixed">switch fixed</button>
        ...
        <b-col md="6">
          <b-card class="main-card mb-3">
            ...
            <br>
            <div class="btn-group btn-group-sm">
              <button class="btn btn-secondary" @click="setValue('demo2', '2016-10-06')">set value = 2016-10-06</button>
