                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3 widget-chart">
                            ...
                            <div class="widget-subheading">Total Views</div>
                            <div class="widget-description"><span class="text-success"><font-awesome-icon icon="angle-up"/><span
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3 widget-chart">
                            ...
                            <div class="widget-numbers">17.2k</div>
                            <div class="widget-subheading">Profiles</div>
                            <div class="widget-description"><span class="text-success pl-1 pr-1"><font-awesome-icon icon="angle-up"/><span
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card mb-3 widget-chart text-left">
                            ...
                            <div class="widget-chart-content">
                                ...
                                <div class="widget-description opacity-8 text-focus">Down by<span class="text-success pl-1 pr-1"><font-awesome-icon icon="angle-down"/>
