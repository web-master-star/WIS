                        ...
                        <div class="tab-content">
                                        ...
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                <div class="widget-content-left mr-3">
                                                    <div class="widget-content-left"><img width="52" class="rounded-circle"
                                                                                          src="@/assets/images/avatars/2.jpg"
                                                                                          alt=""></div>
                                                </div>
                                                <div class="widget-content-left flex2">
                                                    <div class="widget-heading">John Doe</div>
                                                    <div class="widget-subheading opacity-10"><span class="pr-2"><b>43</b> Sales</span><span><b class="text-success">$156,24</b> Totals</span></div>
                                                </div>
                                        ...
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left flex2">
                                                    ...
                                                    <div class="widget-subheading opacity-10"><span class="pr-2"><b class="text-danger">12</b> Leads</span><span><b class="text-warning">$56,24</b> Totals</span></div>
                                                </div>
                                                <div class="widget-content-right">
                                                    <div class="icon-wrapper m-0">
                                                        <div class="progress-circle-wrapper">
                            ...
                            <div class="tab-pane" id="tab-2-eg2">>
                                <ul class="list-group list-group-flush"><a href="javascript:void(0);" class="disabled list-group-item">Cras justo odio</a><a href="javascript:void(0);" class="list-group-item">Dapibus ac facilisis in</a><a
                                    href="javascript:void(0);" class="list-group-item">Morbi leo risus</a><a href="javascript:void(0);" class="list-group-item">Porta ac consectetur ac</a><a href="javascript:void(0);"
                                                                                                                                                                                              class="list-group-item">Vestibulum at
                                    eros</a>
                                </ul>
                            </div>
                    ...
                    <div class="dropdown-menu-header">
                        <div class="dropdown-menu-header-inner bg-focus">
                            ...
                            <div class="menu-header-content btn-pane-right">
                                ...
                                <div class="menu-header-btn-pane">
                                    <button class="btn btn-pill btn-info">Button</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="bg-warm-flame list-group-item">
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left mr-3">
                                        <div class="icon-wrapper m-0 text-center"><b class="text-white d-block w-100 fsize-3"><span>764</span></b></div>
                                    </div>
                                    <div class="widget-content-left">
                            ...
                            <div class="menu-header-content btn-pane-right">
                                ...
                                <div class="menu-header-btn-pane">
                                    <div>
                                        <div role="group" class="btn-group text-center">
                                            <div class="nav">
                                                <a href="#tab-example-161" data-toggle="tab" class="btn btn-focus mr-1">Action</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-left">
                                            ...
                                            <div class="widget-subheading">Group Fiori</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="font-size-xlg text-muted">
                                                <small class="opacity-5 pr-1">$</small>
