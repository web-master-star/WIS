<template>
    <div>
        ...
        <div class="main-card mb-3 card">
            <div class="card-header-tab card-header">
                ...
                <div class="btn-actions-pane-right actions-icon-btn">
                    <b-dropdown toggle-class="btn-icon btn-icon-only" variant="link" no-caret right>
                            ...
                            <div class="widget-chart widget-chart2 text-left p-0">
                                <div class="widget-chat-wrapper-outer">
                                    <div class="widget-chart-content pt-3 pr-3 pl-5">
                                        <div class="widget-chart-flex">
                                            <div class="widget-numbers mb-0 mt-0">
                                                <div class="widget-chart-flex">
                                    ...
                                    <div class="widget-chart-wrapper widget-chart-wrapper-lg he-auto opacity-3 m-0 p-0">
                                        <chart6 :height="210"/>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="tab-eg-11">
                                <div class="card mb-3 widget-chart widget-chart2 text-left p-0 align-items-start" style="min-height: 250px">
                                    <div class="widget-chat-wrapper-outer">
                                        ...
                                        <div class="widget-chart-wrapper he-auto opacity-10 m-0 position-absolute">
                                            <chart5></chart5>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="text-center mb-3"><h5 class="menu-header-title text-capitalize mb-3 fsize-3">Cards</h5>
                ...
                <div class="card-shadow-primary card-border text-white mb-3 card bg-focus">
                    <div class="dropdown-menu-header">
                        <div class="dropdown-menu-header-inner bg-focus">
                            <div class="menu-header-content">
                                <div class="avatar-icon-wrapper mb-3 avatar-icon-xl">
                                    <div class="avatar-icon"><img src="@/assets/images/avatars/2.jpg" alt="Avatar 5"></div>
                                </div>
...
<script>
    ...
    import chart1 from './PM/chart1';
    import chart6 from './PM/chart6';
    import chart7 from './PM/chart7';
    import Vuetable from "vuetable-2";
    import VuetableCssBootstrap from '../Tables/Examples/VuetableCssBootstrap4.js'
